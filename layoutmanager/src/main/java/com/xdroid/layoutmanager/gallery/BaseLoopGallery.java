package com.xdroid.layoutmanager.gallery;
...
public class BaseLoopGallery<T> extends RecyclerView {
    ...
    public void setDatasAndLayoutId(final List<T> datas, int itemLayoutId, BindDataListener bindDataListener) {
        ...
        setAdapter(mAdapter = new CommonAdapter<T>(mContext, datas, itemLayoutId) {
            @Override
            public void onBindViewHolder(com.xdroid.adapter.rv.ViewHolder holder, int position) {
                position = position % mDatas.size();
                super.onBindViewHolder(holder, position);
            }

            @Override
            public void convert(com.xdroid.adapter.rv.ViewHolder viewHolder, T t) {
    ...
    public interface BindDataListener<T> {
        void onBindData(com.xdroid.adapter.rv.ViewHolder holder, T data);
    }
